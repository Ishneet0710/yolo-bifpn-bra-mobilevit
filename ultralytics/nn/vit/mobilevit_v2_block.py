...
try:
    ...
    try:
        from ultralytics.nn.vit.linear_attention import LinearAttnFFN
        from ultralytics.nn.vit.BaseLayers import LayerNorm
    except ImportError:
        import linear_attention
        import BaseLayers
        LinearAttnFFN = linear_attention.LinearAttnFFN
        LayerNorm = BaseLayers.LayerNorm
